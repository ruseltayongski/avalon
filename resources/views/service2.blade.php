...
@section('content')
                            ...
                            <div class="flex h-8 min-w-[50px] items-center justify-center rounded-full text-white relative">
                                <section x-data="{ modalOpen: false }">
                                    <button type="button" @click="modalOpen = true" onclick="triggerModal()">
                                        ...
                                        <span
                                            class="inline-flex items-center justify-center leading-none bg-dark rounded-full absolute z-1"
                                            id="cart-badge">3</span>
                                    </button>
    ...
    <section x-data="{ showCards: 'all', activeClasses: 'bg-[#011523] text-white', inactiveClasses: 'text-body-color hover:bg-[#011523]/80 hover:text-white'}" class="pt-[200px] pb-12 lg:pt-[140px] lg:pb-[90px]">
        <div class="container mx-auto">
            ...
            <div class="-mx-4 flex flex-wrap" x-data='{ modalShow: false, services: @json($services), capitalizeFirstChar: function(str) { return str.charAt(0).toUpperCase() + str.slice(1); } }'>
                    ...
                    <div x-show="showCards === 'all' || showCards === service.category" class="w-full px-4 md:w-1/2 xl:w-1/3">
                        <div class="relative mb-12">
                            ...
                            <div class="relative z-10 mx-7 -mt-20 rounded-lg bg-white py-9 px-3 text-center shadow-lg">
                                ...
                                <section x-data="{modalOpen: false}">
                                    <button type="button" @click="modalOpen = true" class="inline-block rounded-md border py-3 px-7 text-sm font-semibold text-body-color transition hover:border-[#011523] hover:bg-[#011523] hover:text-white">
                                        View Details
                                    </button>
                                    <div x-show="modalOpen" class="fixed top-0 left-0 flex items-center justify-center w-full h-screen py-10 overflow-y-scroll dark:bg-dark" >
                                        <div @click.outside="modalOpen = false" class="mx-auto max-w-[560px] rounded-[10px] bg-white dark:bg-dark-2 p-8 shadow-1 dark:shadow-3">
