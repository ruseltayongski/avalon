                        ...
                        <div class="p-8 bg-white dark:bg-dark-2 rounded-[10px] ">
                            ...
                            <div class="flex items-center justify-start space-x-1">
                                ...
                                <a
                                    ...
                                    class="px-5 py-2 text-sm font-medium bg-white rounded-md text-dark shadow-1 dark:shadow-3
                                     hover:text-white hover:bg-red-dark dark:text-white dark:bg-white/5">
                                    Get it Now
                                </a>
                                <script>
                                    function addCart() {
                            ...
                            <template x-if="pageNumber === 1 || pageNumber === totalPages || (pageNumber >= currentPage - 2 && pageNumber <= currentPage + 2)">
                                <li class="px-[6px]">
                                    <a href="javascript:void(0)"
                                       ...
                                       x-on:click.prevent="currentPage = pageNumber, servicesFetch(currentPage, showCards)"
