        ...
        <div class="container mx-auto">
            ...
            <div class="-mx-4 flex flex-wrap"  x-data='{ modalShow: false, services: @json($services), capitalizeFirstChar: function(str) { return str.charAt(0).toUpperCase() + str.slice(1); } }'>
                ...
                {{-- <div :class="showCards == 'all' || showCards == 'marketing' ? 'block' : 'hidden'" class="w-full px-4 md:w-1/2 xl:w-1/3">
                    <div class="relative mb-12">
                        <div class="overflow-hidden rounded-lg">
                            <img src="{{ asset('/images/portfolio/portfolio-01/image-02.jpg') }}" alt="portfolio"
                                class="w-full" />
                        </div>
                ...
                <div :class="showCards == 'all' || showCards == 'development' ? 'block' : 'hidden'"
                    ...
                    <div class="relative mb-12">
                        <div class="overflow-hidden rounded-lg">
                            <img src="{{ asset('/images/portfolio/portfolio-01/image-03.jpg') }}" alt="portfolio"
                                class="w-full" />
                        </div>
                        <div class="relative z-10 mx-7 -mt-20 rounded-lg bg-white py-9 px-3 text-center shadow-lg">
                            <span class="mb-2 block text-sm font-semibold text-[#011523]">
                ...
                <div :class="showCards == 'all' || showCards == 'design' ? 'block' : 'hidden'"
                    ...
                    <div class="relative mb-12">
                        <div class="overflow-hidden rounded-lg">
                            <img src="{{ asset('/images/portfolio/portfolio-01/image-04.jpg') }}" alt="portfolio"
                                class="w-full" />
                        </div>
                        <div class="relative z-10 mx-7 -mt-20 rounded-lg bg-white py-9 px-3 text-center shadow-lg">
                            <span class="mb-2 block text-sm font-semibold text-[#011523]">
                ...
                <div :class="showCards == 'all' || showCards == 'marketing' ? 'block' : 'hidden'"
                    ...
                    <div class="relative mb-12">
                        <div class="overflow-hidden rounded-lg">
                            <img src="{{ asset('/images/portfolio/portfolio-01/image-05.jpg') }}" alt="portfolio"
                                class="w-full" />
                        </div>
                        <div class="relative z-10 mx-7 -mt-20 rounded-lg bg-white py-9 px-3 text-center shadow-lg">
                            <span class="mb-2 block text-sm font-semibold text-[#011523]">
                ...
                <div :class="showCards == 'all' || showCards == 'branding' ? 'block' : 'hidden'"
                    ...
                    <div class="relative mb-12">
                        <div class="overflow-hidden rounded-lg">
                            <img src="{{ asset('/images/portfolio/portfolio-01/image-06.jpg') }}" alt="portfolio"
                                class="w-full" />
                        </div>
                        <div class="relative z-10 mx-7 -mt-20 rounded-lg bg-white py-9 px-3 text-center shadow-lg">
                            <span class="mb-2 block text-sm font-semibold text-[#011523]">
