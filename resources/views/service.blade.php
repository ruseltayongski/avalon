        ...
        <div class="flex flex-wrap justify-center -mx-4 ">
            @for($i = 0; $i < 12; $i++)
                <div class="w-full px-4 sm:w-4/5 md:w-1/2 lg:w-1/2 mb-8">
                    <div class="group relative mb-8 rounded-xl border border-stroke dark:border-dark-3 bg-white h-full dark:bg-dark-2 p-10 text-center md:px-8 lg:py-9 lg:px-6 xl:py-[45px] xl:px-[43px]" >
                        <div class="relative z-10 inline-flex items-center mx-auto mb-10 h-11" id="whatswedo{{ $i }}">
                        ...
                        <h4 class="text-[#1d5b80] dark:text-white mb-[14px] text-2xl font-bold" id="whatswedo_title{{ $i }}">
                            Marketing Solutions
                        </h4>
                        <p class="text-body-color dark:text-dark-6" id="whatswedo_desc{{ $i }}">
...
<script>
    ...
    for(i = 0; i < 12; i++) {
        elementIds.push("whatswedo_title"+i);
    }

    for(i = 0; i < 12; i++) {
        elementIds.push("whatswedo_desc"+i);
    }
