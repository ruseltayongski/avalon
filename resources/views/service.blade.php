      ...
      <div class="-mx-4 flex flex-wrap">
         <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[510px] text-center">
               ...
               <h2
                  class="mb-3 text-3xl leading-[1.2] font-bold text-white sm:text-4xl md:text-[40px]"
                  >
                  Our Creative Team
               </h2>
      ...
      <div class="-mx-4 flex flex-wrap justify-center">
            ...
            <div class="group mb-8 bg-white dark:bg-dark-2">
               <div class="relative">
                  <img
                     ...
                     />
                  <div
                     class="absolute left-0 bottom-0 flex w-full items-center justify-center space-x-4 opacity-0 transition-all group-hover:bottom-6 group-hover:opacity-100"
                     >
                     <a
                        href="javascript:void(0)"
                        class="flex h-8 w-8 items-center justify-center rounded-full bg-[#4064AC]"
                        >
                        <svg
                           width="8"
                           height="16"
                     ...
                     <a
                        href="javascript:void(0)"
                        class="flex h-8 w-8 items-center justify-center rounded-full bg-[#1C9CEA]"
                        >
                        <svg
                           width="16"
                           height="12"
                     ...
                     <a
                        href="javascript:void(0)"
                        class="flex h-8 w-8 items-center justify-center rounded-full bg-[#D9377B]"
                        >
                        <svg
                           width="15"
                           height="15"
               ...
               <div class="py-6 px-4 text-center">
                  <h3 class="mb-1 text-lg font-semibold text-dark dark:text-white">
                     Melissa Tatcher
                  </h3>
         ...
         <div class="w-full px-4 sm:w-1/2 lg:w-1/3 xl:w-1/4">
            <div class="group mb-8 bg-white dark:bg-dark-2">
               <div class="relative">
                  <img
                     src="https://cdn.tailgrids.com/1.0/assets/images/team/team-06/image-04.jpg"
                     alt="team image"
                     class="w-full"
                     />
                  <div
               ...
               <div class="py-6 px-4 text-center">
                  <h3 class="mb-1 text-lg font-semibold text-dark dark:text-white">Naimur Rahman</h3>
                  <p class="text-body-color dark:text-dark-6 text-sm">
                     Product Designer
                  </p>
               </div>
