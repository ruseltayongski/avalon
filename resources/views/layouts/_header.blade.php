            ...
            <div class="w-full">
               ...
               <nav
                  ...
                  <ul class="block lg:flex justify-end ">
                        ...
                        <li class="lg:ml-6">
                           <a href="{{ route('contact') }}" class="lg:border-white lg:border rounded-full inline-flex items-center justify-center py-3 lg:px-7 text-center text-base font-medium lg:text-white dark:text-white hover:bg-gray-4 dark:hover:bg-dark-3 disabled:bg-gray-3 disabled:border-gray-3 disabled:text-dark-5">
                              Contact Us
                           </a>
                        </li>
                  </ul>
