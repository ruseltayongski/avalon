<div
    ...
    <div @click.outside="modalOpen = false" class="rounded-[10px] shadow-1 dark:shadow-3 h-[95vh] lg:min-w-[500px]">
        <!-- ====== Checkout Section Start -->
        <section >
            <div class="relative w-full bg-white dark:bg-dark-2 pl-4 pr-8 rounded-[10px]">
                <div class="p-8 ">
