<footer class="relative z-10 bg-white dark:bg-dark lg:pt-[120px]"
    ...
    <img class="absolute bottom-0 mx-auto" 
   ...
   <img class="absolute right-0 top-0" src="{{ asset('/images/eclipse-right.png') }}" alt="">
    <div class="container mx-auto">
       <div class="flex flex-wrap opacity-0 justify-center items-center" id="footerSection">
...
<div class="py-1 border-t border-stroke dark:border-dark-3 bg-[#011523]" x-data="{ isMobile: window.innerWidth <= 600 }"
x-init="() => {
   window.addEventListener('resize', () => {
      isMobile = window.innerWidth <= 600;
      console.log(window.innerWidth);
